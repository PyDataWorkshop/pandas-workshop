...
The pandas \texttt{TimeSeries} object is currently limited to a span of about 585 years centered at 1970. While this
...
\begin{verbatim}
	...
	Dates can also be used for slicing using the notation gdp[’d1:d2:’] where d1 and d2 are both valid date
